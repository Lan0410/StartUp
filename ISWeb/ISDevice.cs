namespace ISWeb
{
    public class ISDevice
    {
        public static string GetDeviceType(string ua)
        {
            ...
            // string ua = controllerContext.HttpContext.Request.UserAgent.ToLower();
            if (ua.Contains("ipad") || ua.Contains("iPad"))
            {
                ret = "ipad";
            }
            ...
            {
                ret = "pc";
                // location2 = location2.Replace(".cshtml", ".tablet.cshtml").Replace(".vbhtml", ".tablet.vbhtml");
            }
